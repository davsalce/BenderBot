    ...
    public class OpenAIClient
    {
        ...
        public async Task<string[]?> GetSeriesRecommendationAsync(IEnumerable<string> enumerable)
        {
            var prompt = new
            {
                ...
                Max_tokens = _options.SeriesRecommendations.Max_tokens,
                Temperature = _options.SeriesRecommendations.Temperature,
                Frequency_penalty = _options.SeriesRecommendations.Frequency_penalty,
                Presence_penalty = _options.SeriesRecommendations.Presence_penalty,
                Top_p = _options.SeriesRecommendations.Top_p,
                Best_of = _options.SeriesRecommendations.Best_of,
                Stop = _options.SeriesRecommendations.Stop
            };
